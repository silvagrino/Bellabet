...
Destaca la diferencia entre el 1er y 2do mes. Me interesa analizar la variable de pasos así que llevare los dos meses a tableau para una breve vista podre analizar la diferencia entre estos dos meses :

Suma total:
![](imagenes/1y2/suma_total_steps_1y2.png)
Teniendo en cuenta solo la variable step se debería descartar el 1er mes es considerable la diferencia con el 2do mes.
